...
export enum ErrorCodes {
    ...
    ORDER_MUST_BE_TAKEAWAY_OR_KIOSK,
    TABLE_REQUIRED,
    // Create
    CANNOT_BE_BOTH_TAKEAWAY_AND_KIOSK,
    DUPLICATE_MENU_FIELDS,
    DUPLICATE_MENU_FIELDS_PRODUCT,
    INPUT_MENU_FIELD_PRODUCT_VARIANT,
    INPUT_PRODUCT_VARIANT,
    INPUT_DUPLICATE_PRODUCT_INGREDIENT,
    INPUT_DUPLICATE_MENU_FIELD_PRODUCT_INGREDIENT,
    MENU_DAILY_LIMIT_EXCEEDED,
    MENU_DATE_NOT_VALID,
    ...
    MENU_FIELD_PRODUCT_QUANTITY_EXCEEDED,
    MENU_NOT_EXIST,
    MENU_ROLE_NOT_EXIST,
