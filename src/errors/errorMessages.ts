...
const errorMessagesEn: { [key in number]: string } = {
    ...
    [ErrorCodes.ORDER_MUST_BE_TAKEAWAY_OR_KIOSK]: "Order must be takeaway or kiosk.",
    [ErrorCodes.TABLE_REQUIRED]: "Table required.",
    [ErrorCodes.CANNOT_BE_BOTH_TAKEAWAY_AND_KIOSK]: "Cannot be both takeaway and kiosk.",
    ...
    [ErrorCodes.MENU_DAILY_LIMIT_EXCEEDED]: "Menu daily limit exceeded.",
